...
bot = Discordrb::Bot.new token: "token_bota"
#komendy główne
bot.message(with_text: "-t ping") do |event|
  m = event.respond("Pong!")
  m.edit "🏓 Pong! Upłynęło #{Time.now - event.timestamp} sekund."
end
bot.message(with_text: "-t help") do |event|
  event.user.pm("**Komendy główne:**
  help - to co widzisz! 
  ping - pong!
...
bot.message(with_text: "-t latlog") do |event|
  event.respond "**v0.5.1**
  Zwiększenie bazy statystyk smoków
  Ulepszenia komend"
end
...
bot.message(with_text: "-t iq") do |event|
  iq = rand(-369..369)
  event.respond "Twoje IQ wynosi #{iq}!"
  warn("[INFO]Użyto komendy iq!")
end
bot.message(with_text: "-t gif") do |event|
...
bot.message(with_text: "-t kawał") do |event|
...
bot.message(with_text: "-t klasa uderzeniowa") do |event|
...
bot.message(with_text: "-t klasa tajemnicza") do |event|
...
bot.message(with_text: "-t klasa ognista") do |event|
...
bot.message(with_text: "-t klasa wodna") do |event|
...
bot.message(with_text: "-t klasa ostra") do |event|
...
bot.message(with_text: "-t klasa tropicieli") do |event|
...
bot.message(with_text: "-t klasa kamienna") do |event|
...
bot.message(with_text: "-t Nocna Furia") do |event|
...
bot.message(with_text: "-t Biała Furia") do |event|
...
bot.message(with_text: "-t Wandersmok") do |event|
...
bot.message(with_text: "-t Night Light") do |event|
  event.respond
  warn("[INFO]Użyto komendy Night Light")
end
bot.message(with_text: "-t Śmierciozaur") do |event|
  event.respond
  warn("[INFO]Użyto komendy Śmierciozaur")
end
bot.message(with_text: "-t Potrójny Cios") do |event|
  event.respond
  warn("[INFO]Użyto komendy Potrójny Cios")
end
bot.message(with_text: "-t Wooly Howl") do |event|
  event.respond
  warn("[INFO]Użyto komendy Wooly Howl")
end
bot.message(with_text: "-t staty Nocna Furia") do |event|
...
bot.message(with_text: "-t staty Biała Furia") do |event|
...
bot.message(with_text: "-t staty Wandersmok") do |event|
...
bot.message(with_text: "-t staty Night Light") do |event|
...
bot.message(with_text: "-t staty Mroziczort") do |event|
...
bot.message(with_text: "-t staty Potrójny Cios") do |event|
...
bot.message(with_text: "-t staty Śmierciozaur") do |event|
...
bot.message(with_text: "-t staty Oszołomostrach") do |event|
...
bot.message(with_text: "-t staty Gromogrzot") do |event|
...
bot.message(with_text: "-t staty Wrzeniec") do |event|
...
bot.message(with_text: "-t staty Ogniowa Burza") do |event|
...
bot.message(with_text: "-t staty Podwodny Rozpruwacz") do |event|
...
bot.message(with_text: "-t staty Raziprąd") do |event|
...
bot.message(with_text: "-t staty Fioletowa Śmierć") do |event|
...
#tu do roboty
bot.message(with_text: "-t staty Jaskiniowy Rabuś") do |event|
...
bot.message(with_text: "-t staty Gnatochrup") do |event|
...
bot.message(with_text: "-t staty Marazmor") do |event|
...
bot.message(with_text: "-t staty Piaskowa Zjawa") do |event|
...
bot.message(with_text: "-t staty Sidlarz") do |event|
...
bot.message(with_text: "-t staty Hobgobbler") do |event|
...
#dotąd
bot.message(with_text: "-t staty Bawoleń") do |event|
...
bot.message(with_text: "-t staty Dramilion") do |event|
...
bot.message(with_text: "-t staty Foreverwing") do |event|
...
bot.message(with_text: "-t staty Gronkiel") do |event|
...
bot.message(with_text: "-t staty Krzykozgon") do |event|
...
bot.message(with_text: "-t staty Eruptodon") do |event|
